      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 50 }}>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.searchContainer}>
            ...
            <TextInput style={styles.searchInput} placeholder="Search for donation cards" placeholderTextColor="#A0A0A0" />
          </View>

          <Text style={styles.resultsText}>
            <Text style={{fontWeight: 'bold'}}>{DONATION_CARDS.length}</Text> Cards found
          </Text>
