  ...
  return (
    <View style={[
      ...
      <View style={styles.sidebar}>
        ...
        {/* User Info Card */}
        <Pressable style={({ hovered }: { hovered: boolean }) => [styles.infoCard, hovered && styles.infoCardHover]}>
      ...
      <ScrollView style={styles.mainContent} contentContainerStyle={{ padding: 50 }}>
        ...
        {/* CARD 1: INFORMATION */}
        <Pressable style={({ hovered }: { hovered: boolean }) => [styles.formCard, hovered && styles.formCardHover]}>
        ...
        <Pressable style={({ hovered }: { hovered: boolean }) => [styles.formCard, hovered && styles.formCardHover]}>
          ...
          <View style={styles.buttonContainer}>
            <Pressable 
              style={({ hovered, pressed }: { hovered: boolean; pressed: boolean }) => [
                styles.updateButton,
                hovered && styles.updateButtonHover,
...
const styles = StyleSheet.create({
  ...
  infoCard: { width: '80%', backgroundColor: 'rgba(255, 255, 255, 0.15)', borderRadius: 16, padding: 20, alignItems: 'center', marginBottom: 40, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.2)', transition: 'transform 0.28s ease, box-shadow 0.28s ease' } as any,
  infoCardHover: { transform: [{ translateY: -2 }], boxShadow: '0px 12px 24px rgba(0, 0, 0, 0.12)' } as any,
  ...
  actionButton: { width: 65, height: 65, backgroundColor: 'rgba(255, 255, 255, 0.25)', borderRadius: 16, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.3)', cursor: 'pointer', transition: 'transform 0.25s ease, background-color 0.25s ease, opacity 0.2s ease' } as any,
  actionButtonHover: { backgroundColor: 'rgba(255, 255, 255, 0.35)', transform: [{ translateY: -1 }] } as any,

  // =========================================
  // MAIN CONTENT & FORM STYLES
  // =========================================
  mainContent: { flex: 1, backgroundColor: '#F5F6F8' },
  formCard: { backgroundColor: '#FFFFFF', borderRadius: 20, padding: 40, marginBottom: 30, boxShadow: '0px 10px 30px rgba(0, 0, 0, 0.05)', transition: 'transform 0.28s ease, box-shadow 0.28s ease' } as any,
  formCardHover: { transform: [{ translateY: -2 }], boxShadow: '0px 14px 28px rgba(0, 0, 0, 0.08)' } as any,
  ...
  updateButton: { height: 50, paddingHorizontal: 60, borderRadius: 25, justifyContent: 'center', alignItems: 'center', backgroundImage: 'linear-gradient(to right, #D9898C, #B75658)', boxShadow: '0px 8px 15px rgba(183, 86, 88, 0.3)', cursor: 'pointer', transition: 'transform 0.25s ease, box-shadow 0.25s ease, opacity 0.2s ease' } as any,
  updateButtonHover: { transform: [{ translateY: -1 }], boxShadow: '0px 10px 20px rgba(183, 86, 88, 0.35)' } as any,
